...
# Plot lines of all three Sub_metering values as functions of DateTime, colored by sub_metering number
# Add a legend in upper right corner of graph with line colors
